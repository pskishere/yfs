...
## 一、技术面与基本面综合评估
- **技术趋势**：结合均线、动量指标及成交量，简述当前趋势状态及可靠性。
- **基本面概况**：评估盈利能力、估值水平及市场认可度。
- **新闻影响**：结合最新动态分析其对股价的潜在催化作用。

## 二、综合分析结论
1. **核心观点**：基于上述维度的综合判断及当前市场阶段总结。
2. **风险提示**：列出最关键的技术或基本面风险点。
3. **市场展望**：给出短中期走势预测及应对策略。

---
# 输出要求

1. **简明扼要**: 严格控制篇幅，避免冗长描述，总字数建议在500-800字之间。
2. **数据支撑**: 关键结论需引用具体数值。
3. **重点突出**: 只分析最重要的变化和信号。
4. **语言专业**: 保持专业性且易于阅读。
5. **客观中立**: 不提供确定性的投资指令。
...
## 一、技术面评估
- **趋势与动量**：结合均线、ADX、RSI及MACD，分析当前趋势强度及动能状态。
- **价量与波动**：分析价量配合情况及布林带、ATR显示的波动区间。
- **支撑与压力**：识别核心支撑/阻力位及当前价格位置。
...
1. **简明扼要**: 严格控制篇幅，总字数建议在400-600字之间。
2. **数据支撑**: 引用关键技术指标数值。
3. **重点突出**: 聚焦核心信号，避免面面俱到。
4. **语言专业**: 保持专业性且易于阅读。
5. **分析客观**: 保持中立立场。
